...
class LicenseListView(ttk.Frame):
    ...
    def _build_form(self) -> None:
        form_frame = ttk.LabelFrame(self, text=tr("New License Ticket"))
        ...
        ttk.Button(button_frame, text=tr("Create License"), command=self._add_license).pack(side="right")
    ...
    def _add_license(self) -> None:
        ...
        state = state_to_physical("LicenseState", self.state_var.get().strip(), "active")
